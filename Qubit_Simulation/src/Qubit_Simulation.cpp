...
class Qubit_Simulation{
	...
	void CutQubitSet(const int situation,long long int Probability0,long long int Probability1){
		...
		if(Probability0==0)
			...
			/*if(Probability0+Probability1!=Fixed_Point){

				long long int D=NewtonSqrt((__int128_t)Probability0*Probability0+(__int128_t)Probability1*Probability1);
				Probability0=((__int128_t)Probability0<<Fixed_shift)/D;
				Probability1=((__int128_t)Probability1<<Fixed_shift)/D;
...
int main() {
	...
	std::cout<<a.ObserverQubit(2)<<std::endl;
/*
